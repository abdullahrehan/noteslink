...
function Index({menuButton}) {
  ...
  const openAccountSetting=()=>{
    showAccountSetting ? setShowAccountSetting(false) : setShowAccountSetting(true) 
      ...
      <div className="bg-[#2D2D2D] h-[95%] flex justify-between ">
        ...
        <div className="bg-blue-00 flex ">
          ...
          <div className="pl-2 center h-full pr-4 center bg-red-00">
            <div className={`w-[45px] h-[45px] rounded-full center bg-red-00 hover:cursor-pointer  ${showAccountSetting ? "bg-gradient-to-tr from-pink-400 to-blue-400 ":null} transition duration-700 ease-in-out`} onClick={openAccountSetting}>
