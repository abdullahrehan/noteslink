    ...
    return (
        ...
        <div className='w-[210px] z-20 h-auto bg-[#F0F0F0] absolute rounded-[4px] gap-1 text-sm flex flex-col items-center p-1 pb-2'>
            ...
            {settings.map((data, index) =>
                <>
                    <div key={index} className='flex z-20 h-[30px] w-[95%] hover:bg-[#D9D9D9] hover:cursor-pointer rounded-[2px] flex items-center pl-2' onClick={()=>subSettingFunc(data)} >
