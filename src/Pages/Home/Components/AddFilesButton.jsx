...
function AddFilesButton() {
    return (
        <div className='h-[170px] items-center justify-end overflow-hidden flex flex-col gap-2  bg-red-00 pb-100px]'>
            <div className='w-[45px] h-[45px] rounded-full center bg-[#2D2D2D] hover:bg-[#202020] hover:cursor-pointer'>
                <img src={CreateFolderImg} className='w-[23px] hover:w-[24px]'/>
            </div>
            <div className='w-[45px] h-[45px] rounded-full center bg-[#2D2D2D] hover:bg-[#202020] hover:cursor-pointer'>
                <img src={CreateDocImg} className='w-[23px] hover:w-[24px]'/>
            </div>
            <div className='w-[50px] h-[50px] rounded-full center bg-[#2D2D2D] hover:bg-[#202020] hover:cursor-pointer'>
