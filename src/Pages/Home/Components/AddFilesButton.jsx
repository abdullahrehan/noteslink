...
function AddFilesButton() {
    ...
    return (
        <div className='h-[170px] w-[65px] items-center justify-end overflow-hidden flex flex-col gap-2  bg-red-00 pb-100px] relative'>
            <div className='w-[45px] h-[45px] rounded-full center bg-[#2D2D2D] hover:bg-[#202020] hover:cursor-pointer z-10 transition-all delay-70 duration-400 ease-in-out absolute bottom-[105px]' ref={addFolderRef}>
                <img src={CreateFolderImg} className='w-[23px] hover:w-[24px]'/>
            </div>
            <div className='w-[45px] h-[45px] rounded-full center bg-[#2D2D2D] hover:bg-[#202020] hover:cursor-pointer z-10 transition-all delay-70 duration-400 ease-in-out absolute bottom-[55px]' ref={addFileRef}>
